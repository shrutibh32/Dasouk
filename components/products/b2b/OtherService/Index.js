        ...
        <div className={styles.serviceContainer}>
            <div className={styles.service}>
                <iframe
                    ...
                    allowfullscreen
                ></iframe>
                <h3>Ecommerce under one roof</h3>
                <p>Create a fullfleged online platform to empower multiple vendors to boost their business</p>
                <br />
                <span className={styles.serviceLink}>
                    <span >
                        <Link href='/products/b2c'>MORE</Link>
                    </span>
